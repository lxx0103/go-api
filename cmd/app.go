...
func Run(args []string) {
	...
	router.InitAuthRouter(r, auth.AuthRouter, setting.AuthRouter, item.AuthRouter, purchaseorder.AuthRouter, warehouse.AuthRouter, common.AuthRouter, salesorder.AuthRouter, crm.AuthRouter)
	router.RunServer(r)
}
